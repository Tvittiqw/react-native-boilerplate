...
const TypedAsyncStorage = {
    async getItem<T extends AsyncStorageKeysType>(key: T): Promise<AsyncStorageValueType<T> | null> {
    ...
    setItem<T extends AsyncStorageKeysType>(key: T, value: AsyncStorageValueType<T>): Promise<void> {
