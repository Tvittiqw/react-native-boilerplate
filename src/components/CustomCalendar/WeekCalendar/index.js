...
import {calendarFormattedDate, isToday, sameDay, sameWeekDays, weekPage} from '../../../utils/dateUtils'
...
const WeekCalendar = (props) => {
    ...
    const [selectedDay, setSelectedDay] = useState(selectedDate ? moment(selectedDate): null)
    ...
    return (
        <View>
            {!withoutWeekNames && <WeekNamesComponent containerStyle={{ paddingBottom: 0 }}/>}
